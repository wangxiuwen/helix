# OpsClaw Tools Install Script for Windows
# Usage: irm https://raw.githubusercontent.com/lbjlaq/OpsClaw-Manager/main/install.ps1 | iex
#
...
function Get-ReleaseVersion {
    ...
    Write-Host '  $Version = "4.1.21"; irm https://raw.githubusercontent.com/lbjlaq/OpsClaw-Manager/main/install.ps1 | iex' -ForegroundColor Yellow
    return $false
}

function Get-DownloadUrl {
    # NSIS installer: OpsClaw.Tools_4.1.21_x64-setup.exe
    $script:DownloadUrl = "https://github.com/$Repo/releases/download/v$($script:ReleaseVersion)/OpsClaw.Tools_$($script:ReleaseVersion)_x64-setup.exe"
    $script:Filename = "OpsClaw.Tools_$($script:ReleaseVersion)_x64-setup.exe"
